...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Realix - Empowering Asset Tokenization</title>
        <meta name="description" content="Realix - Tokenize the Future with Ease" />
      ...
      <footer className="bg-gray-800 text-white text-center py-8">
        <div className="max-w-4xl mx-auto">
          <p>&copy; 2024 Realix. All Rights Reserved.</p>
          <div className="mt-4">
